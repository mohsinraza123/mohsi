                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Add New Department</h4>
                                        <hr>
                                        
                                        <form method="post" action="<?php echo base_url();?>Department/saveDept">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Department Name</label>
                                                <div class="col-sm-5">
                                                    <input class="form-control" type="text" name="Department1" Placeholder="Enter Department Name" required="">
                                                </div>
                                                <div class="col-5">
